...
/******/ 			var chunk = require("./" + ({"1":"components/form-submission","2":"components/products","3":"components/sorting","4":"components/svg-basket","5":"components/svg-point","6":"pages/index"}[chunkId]||chunkId) + ".js");
...
const actions = {
  refreshSavedState(context) {
    ...
    if (newProducts) context.commit('setSavedProducts', newProducts);
  },
  ...
  SortByPriceMin(context) {
    ...
    let comparer = (a, b) => {
      if (Number(a.priceProduct) > Number(b.priceProduct)) {
        return 1;
      } else if (Number(a.priceProduct) < Number(b.priceProduct)) {
        return -1;
      } else {
        return 0;
      }
...
__webpack_require__.d(components_namespaceObject, "FormSubmission", function() { return FormSubmission; });
__webpack_require__.d(components_namespaceObject, "Products", function() { return Products; });
__webpack_require__.d(components_namespaceObject, "Sorting", function() { return Sorting; });
__webpack_require__.d(components_namespaceObject, "SvgBasket", function() { return SvgBasket; });
__webpack_require__.d(components_namespaceObject, "SvgPoint", function() { return SvgPoint; });
...
const _1cba37ba = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 6).then(__webpack_require__.bind(null, 49)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(27), 'catalogStore.js'); // If the environment supports hot reloading...
})(); // createStore
...
const FormSubmission = () => __webpack_require__.e(/* import() | components/form-submission */ 1).then(__webpack_require__.bind(null, 44)).then(c => wrapFunctional(c.default || c));
const Products = () => __webpack_require__.e(/* import() | components/products */ 2).then(__webpack_require__.bind(null, 41)).then(c => wrapFunctional(c.default || c));
const Sorting = () => __webpack_require__.e(/* import() | components/sorting */ 3).then(__webpack_require__.bind(null, 40)).then(c => wrapFunctional(c.default || c));
const SvgBasket = () => __webpack_require__.e(/* import() | components/svg-basket */ 4).then(__webpack_require__.bind(null, 33)).then(c => wrapFunctional(c.default || c));
const SvgPoint = () => __webpack_require__.e(/* import() | components/svg-point */ 5).then(__webpack_require__.bind(null, 32)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
/* Plugins */
 ...
 // Source: ..\\plugins\\v-mask.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {
      ...
      "link": [{
        ...
        "rel": "stylesheet",
        "href": "https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Inter:wght@100;200;300;400;500;600;700;800;900&family=Source+Sans+Pro:wght@200;300;400;600;700;900&display=swa",
        "media": "all",
        "disabled": ""
      }],
      "style": [],
  ...
  if (typeof /* Cannot get final name for export "default" in "./plugins/v-mask.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./plugins/v-mask.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
